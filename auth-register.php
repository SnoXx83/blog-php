...
const ERROR_PASSWORD_TOO_SHORT = 'Le mot de pass doit faire au moins 6 caracteres ';
const ERROR_PASSWORD_MISSMATCH = 'Le mot de passe de confirmation ne correspond pas';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$confirm_password) {
        ...
        $errors['confirm_password'] = ERROR_PASSWORD_MISSMATCH;
    }
